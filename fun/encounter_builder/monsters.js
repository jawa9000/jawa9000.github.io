...
const monsters = [
    ...
    },
    {
      ...
      "type": "undead",
      "alignment": "any",
      "environments": ["Ethereal Plane", "Varies"],
      "associates": [""],
      "armor class": "1",
      "hit points": "45 (10d8)",
      "speed": "0 ft, fly 40 ft (hover)",
    ...
    },
    {
      ...
      "type": "fiend",
      "alignment": "lawful evil",
      "environments": ["Infernal Plane", "Arctic"],
      "associates": [""],
      "armor class": "18 (Natural Armor)",
    ...
    },
    {
      ...
      "type": "fiend",
      "alignment": "neutral evil",
      "environments": ["Lower Planes", "Varies", "Ethereal Plane"],
      "associates": [""],
      "armor class": "17 (Natural Armor)",
      "hit points": "112 (15d8 + 45)",
      "speed": "30ft",
    ...
    },
    {
      ...
      "type": "fiend",
      "alignment": "chaotic evil",
      "environments": ["Abyssal Plane", "Infernal Plane"],
      "associates": [""],
      "armor class": "1",
      "hit points": "7 (3d4)",
      "speed": "40ft",
    ...
    },
    {
      ...
      "type": "undead",
      "alignment": "lawful evil",
      "environments": ["Abyss", "Pandemonium", "Negative Energy Plane", "Shadowfell", "Varies", "Urban"],
      "associates": [""],
      "armor class": "16 (Natural Armor)",
    ...
    },
    {
      ...
      "type": "undead",
      "alignment": "neutral evil",
      "environments": ["Negative Energy Plane", "Shadowfell", "Varies", "Urban"],
      "associates": [""],
      "armor class": "15 (Natural Armor)",
      "hit points": "82 (11d8 + 33)",
      "speed": "30ft",
    ...
    },
    {
      ...
      "type": "undead",
      "alignment": "neutral evil",
      "environments": ["Dungeon", "Negative Energy Plane", "Varies"],
      "associates": [""],
      "armor class": "1",
      "hit points": "67 (9d8 + 27)",
    ...
    },
    {
      ...
      "challenge": "5 (1,800 XP)",
      "traits": "<p><em><strong>Mounted Adept.</strong></em> While mounted and without the incapacitated condition, the rider has advantage on melee attack rolls against any unmounted creature smaller than its mount, the rider and its mount have advantage on Dexterity saving throws, and the rider can force an attack targeted at its mount to target the rider instead. [cite: 5]</p><p><em><strong>Undead Fortitude.</strong></em> If damage reduces the rider to 0 hit points, it must make a Constitution saving throw with a DC equal to 5+ the damage taken, unless the damage is radiant or from a critical hit. [cite: 6] On a success, the rider drops to 1 hit point instead. [cite: 7]</p>",
      "actions": "<p><em><strong>Multiattack.</strong></em> The rider makes two Axe attacks. [cite: 8] It can replace one of these attacks with Fell Glare. [cite: 8]</p><p><em><strong>Axe.</strong></em> <em>Melee Weapon Attack:</em> +7 to hit, reach 5 ft., one target. <em>Hit:</em> 13 (2d8+4) slashing damage. [cite: 9]</p><p><em><strong>Fell Glare.</strong></em> The rider gazes at a creature within 30 feet of itself. [cite: 10] The creature must succeed on a DC 13 Wisdom saving throw or have the frightened condition for 1 minute. [cite: 11] The frightened creature can repeat the saving throw at the end of each of its turns, with disadvantage if it can see the rider, ending the condition on itself on a success. [cite: 12]</p>",
      "reactions": "",
      "legendary_actions": "",
